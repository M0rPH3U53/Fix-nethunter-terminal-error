...
Apres avoir ouvert l'apk avec **APK Editor Studio** remplacer `/bin/su` par `/bin/bash` et mettre les " " `"/system/bin/chroot /data/local/nhsystem/kalifs /bin/bash"` dans le fichier kali & enregistrer via **CTRL-S**
